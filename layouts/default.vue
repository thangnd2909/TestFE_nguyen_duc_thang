    ...
    <div class="app-layout-css">
      <client-only>
        ...
        >
            ...
            <template v-for="(item, index) in topmenuAdmin">
              ...
              >
                ...
                >
                  ...
                  <v-list-item-title
                    @click="handleUrlPage(i.page_url)"
                    class="pl-2 pb-2"
                    >{{ i.page_name }}</v-list-item-title
                  >
                </v-list-item>
              </v-list-group>
              <v-list-item
              ...
              >
                ...
                <v-list-item-title @click="handleUrlPage(item.page_url)">{{
                  item.page_name
                }}</v-list-item-title>
              </v-list-item>
            </template>
          ...
          <div class="vesion">
            <div class=" primary--text py-1 fs-14 pr-2" align="right">
              Vesion 1.0
            </div>
          </div>
        </v-navigation-drawer>
        ...
        >
          <template v-slot:activator="{ on }">
            <div class="d-flex align-center cp" v-on="on">
              <div
                class="cp d-flex align-center border-1 py-1 border-radius-50 grey lighten-3"
              >
      ...
      <v-main>
        <v-container fluid>
          ...
          <div class="copyright">
            <div class=" primary--text mb-5  fs-14" align="center">
              copyright © Nguyễn Đức Thắng
            </div>
          </div>
        </v-container>
      </v-main>
